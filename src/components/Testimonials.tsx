...
export default function Testimonials() {
  return (
    <section className="gold-section py-12 bg-[#f3ead2] relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="bg-[#f3ead2]/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-gold-500/30 transition-all duration-300 hover:-translate-y-1"
            >
